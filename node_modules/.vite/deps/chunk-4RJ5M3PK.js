...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const memoTheme2 = React16.useMemo(() => {
...
var SvgIcon = React23.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React23.isValidElement(children) && children.type === "svg";
  const ownerState = {
    ...props,
    color: color2,
    component,
...
function createSvgIcon(path, displayName) {
  ...
  return React24.memo(React24.forwardRef(Component));
}
...
//# sourceMappingURL=chunk-4RJ5M3PK.js.map
